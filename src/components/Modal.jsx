...
const Modal = ({detailId, close}) => {
    //u.uş deyatı sadece modalda kullanılacağı için storeda tanıtmaya gerek duyulmadı
        ...
        <div className="modal-inner">
            ...
            {!d ? (
              ...
              <p>Fotoğraf Bulunamadı</p>
                ...
                <p>
                  <span>Kalkış:</span>
                  <a href={d.airport?.origin?.website} target="_blank"> {c(d.airport?.origin?.name)}</a>
                </p>

                <p>
                  <span>İniş:</span>
                  <a href={d.airport?.destination?.website} target="_blank"> {c(d.airport?.destination?.name)}</a>
                </p>
